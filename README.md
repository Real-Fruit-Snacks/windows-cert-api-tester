...
- **Pop-out response views** — open any response view (Pretty, Raw, Headers, Diagnostics, Rendered, Network) in its own window and keep it beside the main window while you work. The popped-out view stays live — the Network trace keeps streaming, a Rendered page stays interactive — and closing the window puts the view back.
